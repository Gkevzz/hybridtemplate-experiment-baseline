...
export function GuideCard({ guide }: { guide: Guide }) {
  return (
    ...
    >
      <p className="text-xs font-medium uppercase tracking-[0.14em] text-primary">Guide</p>
      <h3 className="mt-3 text-lg font-semibold leading-snug">{guide.title}</h3>
      <p className="mt-3 flex-1 text-sm leading-relaxed text-muted-foreground">{guide.excerpt}</p>
